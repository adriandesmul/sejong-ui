...
class WritingPM extends React.Component {
  ...
  changeContent(content) {
	...
	render() {
    switch(this.state.contentOpen) {
			case 'hipHop':
				return (
	      	<div>
						<div className="row">
							<div className="theater-tab-contain col-item">
								<div className="theater-tab active" onClick={() => {this.changeContent('hipHop')}}>
									<h3>Hip-hop</h3></div>
			          <div className="theater-tab" onClick={() => {this.changeContent('jazz')}}>
									<h3>Jazz</h3></div>
			          <div className="theater-tab" onClick={() => {this.changeContent('classical')}}>
									<h3>Classical</h3></div>
			          <div className="theater-tab" onClick={() => {this.changeContent('art')}}>
									<h3>Korean Art Songs</h3></div>
							</div>
							<div className="col-item">
								<iframe width="720" height="405" src="https://www.youtube.com/embed/hZGiu7k9iFA" frameBorder="0" allow="autoplay; encrypted-media" className="theater-mov" allowFullScreen></iframe>
								<div className="theater-mov-caption">
									<h1>Hip-hop</h1>
									<div className="row">
										<div className="col-item">
											<h2>Elephant Rebellion</h2>
											<p><b>TJ “TJ GT” Ayodele<br/>
												Elgin “DJ LOKari” Bokari<br/>
												Mergen “Monotone” Batdelger</b></p>
										</div>
										<div className="col-item">
											<p><b>Suwan Choi</b>, jang-gu</p>
										</div>
									</div>
								</div>
							</div>
	            ...
	            : null }
							...
							<p>based on "Chung-sang-ri" by Hwang Chin-i (c. 1506-1720)</p>
							<blockquote>
			...
			case 'jazz':
				return (
					<div>
						<div className="row">
							<div className="theater-tab-contain col-item">
								<div className="theater-tab" onClick={() => {this.changeContent('hipHop')}}>
									<h3>Hip-hop</h3></div>
								<div className="theater-tab active" onClick={() => {this.changeContent('jazz')}}>
									<h3>Jazz</h3></div>
								<div className="theater-tab" onClick={() => {this.changeContent('classical')}}>
									<h3>Classical</h3></div>
								<div className="theater-tab" onClick={() => {this.changeContent('art')}}>
							...
							<div class="col-item">
								<div className="theater-mov">
									<iframe width="720" height="405" src="https://www.youtube.com/embed/VkH1FPlkaJg" frameBorder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
								</div>
								<div className="theater-mov-caption">
									<h1>Jazz</h1>
									<div className="row">
										<div className="col-item">
											...
											<p><b>Adam Dib</b>, alto saxophone<br/>
												...
												<b>Lyle Luckett</b>, percussion</p>
										</div>
										<div className="col-item">
											<p><b>Scott Hall</b>, composer</p>
										</div>
									</div>
								</div>
							</div>
					...
					<div>
						<div className="row">
							<div className="theater-tab-contain col-item">
								...
								<div className="theater-tab" onClick={() => {this.changeContent('jazz')}}>
									<h3>Jazz</h3></div>
								<div className="theater-tab active" onClick={() => {this.changeContent('classical')}}>
									<h3>Classical</h3></div>
								<div className="theater-tab" onClick={() => {this.changeContent('art')}}>
									<h3>Korean Art Songs</h3></div>
							</div>
							<div class="col-item">
								<div className="theater-mov">
									<iframe width="720" height="405" src="https://www.youtube.com/embed/2saZZb3NEbg" frameBorder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
								</div>
								<div className="theater-mov-caption">
					...
					<div>
						<div className="row">
							<div className="theater-tab-contain col-item">
								...
								<div className="theater-tab" onClick={() => {this.changeContent('classical')}}>
									<h3>Classical</h3></div>
								<div className="theater-tab active" onClick={() => {this.changeContent('art')}}>
									<h3>Korean Art Songs</h3></div>
							</div>
							<div class="col-item">
								<div className="theater-mov">
									<iframe width="720" height="405" src="https://www.youtube.com/embed/HFInmnQ7vTc" frameBorder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
								</div>
								<div className="theater-mov-caption">
